    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('difficulty', models.CharField(choices=[(0, 'Difficulty Not Set'), (1, 'Very Easy'), (2, 'Easy'), (3, 'Normal'), (4, 'Hard'), (5, 'Very Hard')], default=0, max_length=1)),
                ('exploit_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='lesson_exploit_type', to='learn.exploittype')),
                ('owner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='lesson_created', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Image',
